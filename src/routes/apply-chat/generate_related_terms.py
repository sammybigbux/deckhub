...
assistant_id = "asst_iMf7GqTbtJHumZ2XaEWMVD8l"
...
def is_valid_response(response_dict):
    ...
    if scenario[-1] != '?':
        return False
    related_terms = response_dict[category][scenario]
...
def main(file_path, test_mode=False):
    ...
    with open('related_terms.json', 'w') as outfile:
        json.dump(merged_data, outfile, indent=2)

    print("Processing complete. Merged JSON data has been written to 'related_terms.json'.")
