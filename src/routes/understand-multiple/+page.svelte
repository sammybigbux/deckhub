    ...
    let messageFeed: Message[] = [
        {
            ...
            message: 'Hi! This is your **AI coach** for the AWS SAA-03 exam. The goal of this section is to help you understand the relationships between terms and definitions from the last section by answering and getting feedback on multiple choice questions. Are you ready to get started?',
