    ...
    let messageFeed: Message[] = [
        {
            ...
            message: 'Hi! This is your **AI coach** for the AWS SAA-03 exam. The goal of this section is to help you react to real life scenarios like the ones on the exam by answering and getting feedback on multiple choice and open-ended questions. Are you ready to get started?',
